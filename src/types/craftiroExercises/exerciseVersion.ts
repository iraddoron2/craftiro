...
export type ExerciseVersion = {
    ...
    assets: {
        ...
        resources?: { key: string; value: CraftiroElement[] }[] | null // Additional resources (links, YouTube, worksheets). Example: ['https://youtube.com/...']
        solution?: CraftiroElement[] | null // Sample solution or answer. Example: 'Correct notes: C D E F G' or image/video link
