...
const module21: Module = {
    ...
    metadata: {
        ...
        contentMetadata: {
            title: 'ניתוח מוזיקלי: ואלס מספר 2 של שוסטקוביץ׳',
            categories: ['מוזיקה'],
            tags: ['פסנתר'],
            ...
            language: 'עברית',
            betaVersionUrl:
                'https://docs.google.com/document/d/1msDtf004Gi4t0TjElLD3PVJywVOMsqtVWkzqHayxML0/edit?usp=drive_link',
        },
    },
}
